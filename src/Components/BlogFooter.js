  ...
  return (
    <footer className='App-Footer'>
      ...
      <div className="Footer-col2 Footer-Col">
        ...
        <Link className='footerLinks' to='/hollywood'>HOLLYWOOD</Link>
        <Link className='footerLinks' to='/bollywood'>BOLLYWOOD</Link>
        <Link className='footerLinks' to='/fitness'>FITNESS</Link>
        <Link className='footerLinks' to='/technology'>TECHNOLOGY</Link>
        <Link className='footerLinks' to='/sports'>SPORTS</Link>
      </div>
